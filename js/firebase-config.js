...
import { getDatabase, ref, push, onChildAdded, onChildChanged, onValue, set, get, update, serverTimestamp, query, orderByChild, equalTo, off } from "https://www.gstatic.com/firebasejs/10.8.1/firebase-database.js";
...
export { db, auth, provider, signInWithPopup, onAuthStateChanged, signOut, deleteUser, ref, push, onChildAdded, onChildChanged, onValue, set, get, update, serverTimestamp, query, orderByChild, equalTo, off };
